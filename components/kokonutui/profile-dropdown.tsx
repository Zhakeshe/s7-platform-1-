                ...
                <div className="group relative">
                        ...
                        >
                            <div className="text-left flex-1">
                                ...
                                {typeof data.xp === 'number' && (
                                  <div className="mt-1 text-[11px] text-[var(--color-accent-warm)]">XP: {data.xp}</div>
                                )}
                            </div>
                            <div className="relative">
                              <div className="w-10 h-10 rounded-full ring-2 ring-[var(--color-accent-warm)]/40 ring-offset-2 ring-offset-[#16161c] bg-[#0f0f14] flex items-center justify-center">
                    ...
                    >
                        <div className="px-2 pb-2">
                          ...
                          {typeof data.xp === 'number' && (
                            <div className="mt-1 inline-flex items-center gap-1 rounded-md bg-[#0f0f14] border border-[#2a2a35] px-2 py-0.5 text-[11px] text-[var(--color-accent-warm)]">XP: {data.xp}</div>
                          )}
                        </div>
                        {menuItems.length > 0 && (
